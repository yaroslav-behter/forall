...
$https= DOMAIN_HTTPS;
// Контакты
$title = "Пополнить Betfair за Webmoney WMU";
$Keywords = "Betfair за WMU, пополнить BetFair, перевод WMU на BETFAIR, продать, обмен, обменник, электронная валюта, платежная система";
$Description = "онлайн обмен wmu на Betfair, пополнение счета в Betfair за WMU на любую сумму";
...
EOT;
    ...
    echo <<<EOT
	 ...
	 <tr><td class="lsh"></td><td id="pbl">
       <h1>Пополнить счет Betfair за WMU</h1>
	 </td>
	 <td id="pbr">&nbsp;
    </td><td class="rsh"></td>
	 </tr>
     <tr height="600"><td class="lsh"></td><td id="content" colspan="2">
      ...
      <p>Сервис по пополнению счетов Betfair за WMU.</p>
...
EOT;
    ...
    echo <<<EOT
      ...
      <form enctype="multipart/form-data" method="post" name="makeexchange" id="makeexchange" action="$domain/specification.asp">
		...
		Внести сумму WMU <input type="text" name="InSum3" value="" onclick="OutSum8.value=InSum2OutSum('WMU', 'PSU', InSum3.value);" onkeypress="OutSum8.value=InSum2OutSum('WMU', 'PSU', InSum3.value);" onkeyup="OutSum8.value=InSum2OutSum('WMU', 'PSU', InSum3.value);"><br />
		Сумма на счет Betfair <input type="text" name="OutSum8" value="" readonly><br /><br />
